...
const Home = ({ user }) => {
  ...
  const userUpdate = async (userObject, setPreviewSource, setErros, axios) => {
    try {
      setErros({});
  ...
  const handleEditForm = async (e) => {
    ...
    userUpdate(userObject, setPreviewSource, setErros);
  ...
  const handleSubmitPass = (e) => {
    ...
    if (isValid) {
      userUpdate(userObject, setPreviewSource, setErros, axios);
    } else {
      setErros(errors);
    }
  };
